...
**Counts.** 821 JS tests (core 546, mobile 254, i18n 10, ui 11; 742 on `main` before the round) and 13 Rust
tests. `pnpm lint` and `pnpm typecheck` clean. Green run: `docs/qa/fixes-r24b/tests.txt`.

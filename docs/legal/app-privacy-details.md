...
| 3.1.1 In-app purchase | Pro/Work via StoreKit only; Family Sharing for Pro is an open decision for Moshe (the paywall says "not enabled yet"; not enabled in 1.0 unless he decides) |

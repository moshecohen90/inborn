...
documents with 83 on-topic and 143 off-topic questions, and 8 six-chunk documents with 27 and 54. Each model runs
...
Ranks the answering chunk first for at least 24 of 27, **and** some cosine threshold T gives at least 73 of 83
...
|---|---|---|---|---|---|---|
| nomic-v1.5 | 39/83 | 0/143 | 0.7642 | **39/83** | 0/143 | 0 |
| e5-large-inst-q6 | 39/83 | 0/143 | 0.8177 | **77/83** | 0/143 | 0.0006 |
...
|---|---|---|---|---|---|---|---|
| nomic-v1.5 | 0.7642 | **39/83** | 0/143 | 5/27 | 4 | 1 | 3/54 |
| e5-large-inst-q6 | 0.8177 | **77/83** | 0/143 | 25/27 | 25 | 0 | 3/54 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| nomic-v1.5 | 0/5 | 0/2 | 4/10 | 1/5 | 1/3 | 0/5 | 0/1 | 3/5 | 8/14 | 3/6 | 3/5 | 1/2 | 7/10 | 8/10 |
| e5-large-inst-q6 | 5/5 | 2/2 | 8/10 | 4/5 | 2/3 | 5/5 | 0/1 | 5/5 | 13/14 | 6/6 | 5/5 | 2/2 | 10/10 | 10/10 |

## Size, licence and cost

`ms/text` is wall clock on this Mac (M-series, Metal) over the whole 369-text pass including model load, a proxy
for the phone, not a phone number.

| candidate | family | arch | params | dim | file | licence | ms/text | source |
|---|---|---|---|---|---|---|---|---|
| nomic-v1.5 | nomic-embed-text-v1.5 | nomic-bert | 137M | 768 | 274 MB | Apache-2.0 | 3.35 | `nomic-ai/nomic-embed-text-v1.5-GGUF` |
| e5-large-inst-q6 | multilingual-e5-large-instruct | bert | 560M | 1024 | 468 MB | MIT | 9.08 | `Ralriki/multilingual-e5-large-instruct-GGUF/multilingual-e5-large-instruct-q6_k.gguf` |

## What passes the bar

| candidate | answering chunk first | on-topic | off-topic | wrong-only citations | file |
|---|---|---|---|---|---|
| e5-large-inst-q6 | 25/27 | 77/83 | 0/143 | 0 | 468 MB |
...
|---|---|---|---|---|---|---|
| nomic-v1.5 | **39/83** | 0/143 | 5/27 | 4 | 1 | 3/54 |
| e5-large-inst-q6 | **75/83** | 0/143 | 25/27 | 25 | 0 | 3/54 |
...
|---|---|---|---|---|---|
| e5-large-inst-q6 | 77/83, 0 off | 71/83, 0 off | 67/83, 0 off | 61/83, 0 off | 47/83, 0 off |

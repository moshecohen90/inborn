...
const SIZE_MENTIONS = [
  ["index.html", ["Your browser downloads one model once: {{SIZE_INSTANT}} (Instant) or {{SIZE_FAST}} (Fast, on capable computers and tablets)", "The Instant model, {{SIZE_INSTANT}}, arrives with the app", "the Instant model it runs is {{SIZE_INSTANT}}", "In a browser, one model downloads once into the browser's own storage: {{SIZE_INSTANT}} (Instant) or {{SIZE_FAST}} (Fast, on capable computers and tablets)"]],
  ["download.html", ["The Instant model, {{SIZE_INSTANT}}, arrives with the app", "Your browser downloads one model once into its own storage: {{SIZE_INSTANT}} (Instant) or {{SIZE_FAST}} (Fast, on capable computers and tablets)"]],

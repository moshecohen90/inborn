 ...
 *
 * Environment:
 *   SITE_ORIGIN   canonical origin for links, sitemap and JSON-LD (default the real production host)
...
export const siteOrigin = process.env.SITE_ORIGIN ?? "https://inbornapp.com";

...
/** Dev bundles may pretend to own Pro (`EXPO_PUBLIC_PRO=1`) or Work (`EXPO_PUBLIC_PRO=work`) to walk the gated screens; release bundles only trust the licence. */
export const DEV_TIER: "pro" | "work" | null = !__DEV__ ? null : process.env.EXPO_PUBLIC_PRO === "work" ? "work" : process.env.EXPO_PUBLIC_PRO === "1" ? "pro" : null;

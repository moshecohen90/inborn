...
export const UserMessage = memo(function UserMessage({ message, onLongPress }: { message: ChatMessage; onLongPress: () => void }) {
  ...
  return (
    <Pressable testID="user-message" onLongPress={onLongPress} delayLongPress={350} {...actionsMenuProps(onLongPress, Platform.OS)} accessibilityRole="text" style={[styles.bubble, { backgroundColor: theme.surface1 }]}>

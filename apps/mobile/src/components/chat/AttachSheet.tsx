...
export function AttachSheet({ visible, onClose, documents, attachedIds, strict, onSetStrict, onAttach, onDetach, onManage, onImport, onPhoto, photoNote, photoDisabled }: Props) {
  const type = useType();

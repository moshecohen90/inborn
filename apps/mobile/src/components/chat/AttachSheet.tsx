...
export function AttachSheet({ visible, onClose, documents, attachedIds, strict, onSetStrict, strictLocked, onUnlock, onAttach, onDetach, onManage, onPhoto, photoNote, photoDisabled, onUseVisionModel, visionModel, onInstallVision, visionSize, onImport, onTemplates }: Props) {
  const type = useType();

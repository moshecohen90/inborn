...
import { WHISPER_MODEL_ID } from "../voice/whisper";
...
export default function VoiceRoute() {
  ...
  return <HandsFreeScreen chatId={params.chat ?? null} incognito={params.incognito === "1"} onClose={() => (router.canGoBack() ? router.back() : router.replace("/"))} onOpenVault={() => router.replace({ pathname: "/vault", params: { focus: WHISPER_MODEL_ID } })} />;
}
